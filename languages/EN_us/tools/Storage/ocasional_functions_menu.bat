...
echo.
echo 8: Extract gamesaves?
echo.
echo 9: Launch Linux ^(obsolete function^)?
echo.
echo 10: Update Shofel2 ^(obsolete function^)?
echo.
echo 11: Compress/uncompress a game with nsZip ^(obsolete function^)?
echo.
